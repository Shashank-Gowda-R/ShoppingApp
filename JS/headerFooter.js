...
clothingAnker.className = 'cloth';
clothingAnker.id = 'cloth';
...
accessoriesAnker.className = 'access';
accessoriesAnker.id = 'access';
...
cartNav.href = '../HTML/checkoutPage.html';
cartNav.className = 'cartIcon';
cartNav.id = 'cartIcon';
...
var container = Object.assign(document.createElement('div'),{className:'container'});
var rows = Object.assign(document.createElement('div'),{className:'row'});

var onlineStore = document.createElement('div');
onlineStore.className = 'pdl0 footerDiv';
...
rows.appendChild(onlineStore);

var helpfulLinks = document.createElement('div');
helpfulLinks.className = 'footerDiv';
...
rows.appendChild(helpfulLinks);

var partners = document.createElement('div');
partners.className = 'footerDiv';
...
rows.appendChild(partners);

var address = document.createElement('div');
address.className = 'footerDiv';
